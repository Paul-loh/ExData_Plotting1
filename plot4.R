...
## Set the device to hold 4 plots  
par(mfcol=c(2,2))

## PLOT 1
## Plot the line graph with day of week along the x-axis and Global Active Power along the y-axis  
...
## Add the legend
##legend('topright', legend = c("Sub_metering_1", "Sub_metering_2", "Sub_metering_3"), col = c("black", "red", "blue"), lty = 1, xjust = 0)
legend('topright', legend = c("Sub_metering_1", "Sub_metering_2", "Sub_metering_3"), col = c("black", "red", "blue"), lty = 1, bty = "n")

## PLOT 3
## Plot DateTime along the x-axis and Voltage on the y-axis
plot(d2$DateTime, d2$Voltage, type = "l", xlab = "datetime", ylab = "Voltage")

## PLOT 4 
## Plot DateTime along the x-axis and Global Reactive Power on the y-axis
